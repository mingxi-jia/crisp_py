...
END_EFFECTOR_FRAME = "attachment_site"  # End effector frame for FR3
CTRL_FREQ = 10.0  # Hz
...
def main():
    parser = argparse.ArgumentParser(description='Visualize Pink IK trajectory')
